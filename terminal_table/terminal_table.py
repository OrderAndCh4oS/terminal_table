...
class Table:
    @staticmethod
    def create(rows, headers, row_colours=None, column_colours=None, header_colours=None, header_colour=None):
    ...
    @staticmethod
    def make_row(row, col_widths, separator="|", column_colours=None, row_colour=None):
        if column_colours is None:
            column_colours = []
...
if __name__ == '__main__':
    plain = Table.create([[1, 2, 3], [4, 5, 6], [7, 8, 9]], ['a', 'b', 'c'])
    print(plain)
